...
public class ParseHandler extends DefaultHandler {
    ...
    private boolean inDate, inDay, inTime, inPredCm, inPredFt, inHighLow, inLocation;
    ...
    public void startElement(String namespaceURI, String localName, String qName,
        ...
        if(qName.equals("stationname")) { inLocation = true; }
    ...
    public void endElement(String namespaceURI ,String localName, String qName)
        ...
        if(qName.equals("stationname")) { inLocation = false; }
    ...
    public void characters(char[] ch, int start, int length) throws SAXException {
        if (inLocation) item.setLocation(new String(ch, start, length));
